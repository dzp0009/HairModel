...
bool ImageLayerRenderer::create(ID3DX11Effect* pEffect)
{
	release();

	m_hTechnique = pEffect->GetTechniqueByName("ImageLayer");
...
void ImageLayerRenderer::release()
{
...
void ImageLayerRenderer::render()
{
